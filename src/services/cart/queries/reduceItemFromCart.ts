...
import { CartReduceItemRequest } from 'models/Cart/CartRequest';
...
export const reduceItemFromCart = (
    ...
    builder.mutation<CartResponse, CartReduceItemRequest>({
        query: (arg: CartReduceItemRequest) => ({
            url: `api/v2/cart/reduce-item`,
            method: 'PUT',
            body: {
                ...arg,
            },
